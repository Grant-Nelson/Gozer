...
func (imp *projectImp) Interfaces() collections.List[InterfaceModel] { return imp.interfaces }
func (imp *projectImp) Objects() collections.List[ObjectModel]       { return imp.objects }
func (imp *projectImp) Signatures() collections.List[SignatureModel] { return imp.signatures }
...
func (imp *projectImp) MarshalJSON() ([]byte, error) {
	...
	addList(data, `interfaces`, imp.Interfaces())
	addList(data, `objects`, imp.Objects())
	addList(data, `signatures`, imp.Signatures())
