...
func TestSubtypes(t *testing.T) {
	checkType(t, (*ListType)(nil).Subtype(), "nil")
	checkType(t, List(Int()).Subtype(), "int")
	checkType(t, List(String()).Subtype(), "string")
	checkType(t, (*MapType)(nil).Subtype(), "nil")
	checkType(t, Map(Int(), Int()).Subtype(), "int")
	checkType(t, Map(String(), String()).Subtype(), "string")
	checkType(t, (*StringType)(nil).Subtype(), "uint8")
	checkType(t, String().Subtype(), "uint8")
}
